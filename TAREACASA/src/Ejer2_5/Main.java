...
CuentaBancaria cuenta1 = new CuentaBancaria ("Pedro","Perez",123456, CuentaBancaria.tipo.AHORROS,0,0.12);
CuentaBancaria cuenta2= new CuentaBancaria("Pablo","Pablin",45678954, CuentaBancaria.tipo.AHORROS,0,0.12);
CuentaBancaria cuenta3 = new CuentaBancaria("Dre","Andia",4225865, CuentaBancaria.tipo.CORRIENTE,0,0);
cuenta1.imprimir();
